...
namespace gct {
  ...
  class allocator_t :
    public property< VmaAllocatorCreateInfo >,
    public created_from< device_t >,
    public std::enable_shared_from_this< allocator_t > {
  public:
    allocator_t(
    ...
    [[nodiscard]] const VmaAllocator &operator*() const { return *handle; }
    [[nodiscard]] std::shared_ptr< image_t > create_image(
      const image_create_info_t&,
      VmaMemoryUsage usage
    );
    [[nodiscard]] std::vector< std::shared_ptr< image_view_t > > create_image_views(
      const image_create_info_t&,
      VmaMemoryUsage usage,
      unsigned int count
    );
    [[nodiscard]] std::shared_ptr< image_view_t > create_image_view(
      const image_create_info_t&,
      VmaMemoryUsage usage
    );
    [[nodiscard]] std::shared_ptr< buffer_t > create_buffer(
    ...
    [[nodiscard]] std::shared_ptr< mappable_buffer_t > create_mappable_buffer(
      const buffer_create_info_t&
    );
    [[nodiscard]] std::shared_ptr< mappable_buffer_t > create_mappable_buffer(
      std::size_t size,
    ...
    [[nodiscard]] std::shared_ptr< pixel_buffer_t > create_pixel_buffer(
    ...
    [[nodiscard]] std::shared_ptr< pixel_buffer_t > load_image(
