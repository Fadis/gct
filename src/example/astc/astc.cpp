...
int main( int argc, char *argv[] ) {
  ...
  auto normal_image_view = normal_image->get_view(
    gct::image_view_create_info_t()
      .set_basic(
        vk::ImageViewCreateInfo()
          .setSubresourceRange(
            vk::ImageSubresourceRange()
              .setAspectMask( vk::ImageAspectFlagBits::eColor )
              .setBaseMipLevel( 0 )
              .setLevelCount( normal_image->get_props().get_basic().mipLevels )
              .setBaseArrayLayer( 0 )
              .setLayerCount( normal_image->get_props().get_basic().arrayLayers )
          )
          .setViewType( gct::to_image_view_type( normal_image->get_props().get_basic().imageType, base_color_image->get_props().get_basic().arrayLayers ) )
          .setFormat( vk::Format::eR8G8B8A8Unorm )
      )
      .rebuild_chain()
  );
  auto roughness_image_view = roughness_image->get_view(
    gct::image_view_create_info_t()
      .set_basic(
        vk::ImageViewCreateInfo()
          .setSubresourceRange(
            vk::ImageSubresourceRange()
              .setAspectMask( vk::ImageAspectFlagBits::eColor )
              .setBaseMipLevel( 0 )
              .setLevelCount( roughness_image->get_props().get_basic().mipLevels )
              .setBaseArrayLayer( 0 )
              .setLayerCount( roughness_image->get_props().get_basic().arrayLayers )
          )
          .setViewType( gct::to_image_view_type( roughness_image->get_props().get_basic().imageType, base_color_image->get_props().get_basic().arrayLayers ) )
          .setFormat( vk::Format::eR8G8B8A8Unorm )
      )
      .rebuild_chain()
  );
    ...
    updates.push_back(
      gct::write_descriptor_set_t()
        ...
        .add_image(
          gct::descriptor_image_info_t()
            .set_sampler( base_color_sampler )
            .set_image_view( normal_image_view )
            .set_basic(
              vk::DescriptorImageInfo()
                .setImageLayout(
                  normal_image->get_layout().get_uniform_layout()
                )
            )
        )
    );
