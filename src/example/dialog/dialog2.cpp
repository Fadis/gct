...
int main() {
  ...
  );
  {
    const std::vector< std::uint32_t > glyphs{
      3190, 3247, 3218, 3297, 3269, 3267, 3342, 3281, 3210, 3196, 3110
    };
    const std::vector< float > glyph_pos{
      0, 53.424, 106.848, 160.272, 213.696, 267.12, 320.544, 373.968, 427.392, 480.816, 534.24,
    };
    for( unsigned int i = 0u; i != glyphs.size(); ++i ) {
      window.add_glyph(
        0, glyphs[ i ], 200.f+glyph_pos[ i ]/2.f, 200.f, 13.356f*2,
        gct::srgb_oetf( gct::html_color( 0x000000 ) ),
        3u, 0u, 0u
      );
    }
  }
  {
    ...
    for( unsigned int i = 0u; i != glyphs.size(); ++i ) {
      window.add_glyph(
        0, glyphs[ i ], 420.f+glyph_pos[ i ], 75.f, 13.356f*2,
        gct::srgb_oetf( gct::html_color( 0x000000 ) ),
        3u, 0u, 0u
      );
    }
  }
  {
    ...
    for( unsigned int i = 0u; i != glyphs.size(); ++i ) {
      window.add_glyph(
        0, glyphs[ i ], 150.f+glyph_pos[ i ], 75.f, 13.356f*2,
        gct::srgb_oetf( gct::html_color( 0x000000 ) ),
        3u, 0u, 0u
      );
    }
