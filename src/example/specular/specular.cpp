...
int main() {
  ...
  const auto vs = device->get_shader_module( "./src/example/specular/shader.vert.spv" );
  const auto fs = device->get_shader_module( "./src/example/specular/shader.frag.spv" );
