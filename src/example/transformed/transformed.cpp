...
int main() {
  ...
  const auto vs = device->get_shader_module( "./src/example/transformed/shader.vert.spv" );
  const auto fs = device->get_shader_module( "./src/example/transformed/shader.frag.spv" );
