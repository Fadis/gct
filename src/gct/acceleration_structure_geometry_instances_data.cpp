...
namespace gct {
  ...
  acceleration_structure_geometry_instances_data_t &acceleration_structure_geometry_instances_data_t::set_data( const std::shared_ptr< device_or_host_address_const_t > &v ) {
    data = v;
    chained = false;
    return *this;
  }
  acceleration_structure_geometry_instances_data_t &acceleration_structure_geometry_instances_data_t::clear_data() {
    data.reset();
    chained = false;
    return *this;
  }
  void acceleration_structure_geometry_instances_data_t::to_json( nlohmann::json &root ) const {
