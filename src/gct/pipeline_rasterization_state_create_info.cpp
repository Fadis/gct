...
#include <vulkan2json/DepthBiasRepresentationInfoEXT.hpp>
#endif
...
#ifdef VK_EXT_DEPTH_BIAS_CONTROL_EXTENSION_NAME
    LIBGCT_EXTENSION_TO_JSON( depth_bias_representation )
#endif
#ifdef VK_EXT_CONSERVATIVE_RASTERIZATION_EXTENSION_NAME
...
#ifdef VK_EXT_DEPTH_BIAS_CONTROL_EXTENSION_NAME
    LIBGCT_EXTENSION_FROM_JSON( depth_bias_representation )
#endif
#ifdef VK_EXT_CONSERVATIVE_RASTERIZATION_EXTENSION_NAME
...
#ifdef VK_EXT_DEPTH_BIAS_CONTROL_EXTENSION_NAME
    LIBGCT_EXTENSION_REBUILD_CHAIN( depth_bias_representation )
#endif
#ifdef VK_EXT_CONSERVATIVE_RASTERIZATION_EXTENSION_NAME
